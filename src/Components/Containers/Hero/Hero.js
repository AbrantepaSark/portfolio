      ...
      >
        <div className="container flex justify-center items-center w-4/5 md:w-1/2">
          <div className="text-center text-white ">
            ...
            <p className="font-bold text-5xl md:text-6xl">Web Developer</p>
            <p className="leading-6 text-xl md:mt-4 mt-2 font-light">
              Are you looking for a developer for an amazing user interface With
              great user experience? Lets get connected. I analyse, design and
