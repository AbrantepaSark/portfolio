      ...
      <div className="h-[200px] max-w-md gap-x-1 flex flex-row  drop-shadow-md bg-white">
        ...
        <div className="flex-1 py-5 px-5">
          ...
          <p className="text-justify text-sm">
            This is a ToDo app that built to help users manage
            their tasks{" "}
          </p>
          <button className="bg-slate-500 hover:bg-slate-800 rounded-md text-white text-sm py-2 px-4 mx-auto md:mt-5 mt-5">
            Visit Site
          </button>
        </div>
      </div>
